            ...
            <div className="container mx-auto h-[calc(100vh-80px)] flex justify-center">
                ...
                {!toggleForm &&
                    <div className="flex flex-col w-[50%]">
                        <div className="flex items-center justify-center h-[80px] mt-[50px]">
                            <button onClick={() => setToggleForm(false)} className="bg-primary text-white rounded-l-lg w-[100px] h-[50px]">Sign in</button>
                            <button onClick={() => setToggleForm(true)} className="border-2 rounded-r-lg w-[100px] h-[50px]">Sign up</button>
                        </div>
                        <div className="flex flex-col items-center h-[500px]">
                            ...
                            <button className="bg-primary text-white rounded-lg mt-[25px] w-[100px] h-[50px]">Login</button>
                        </div>
                    </div>
                }
                ...
                {toggleForm &&
                    <div className="flex flex-col">
                        <div className="flex items-center justify-center h-[80px] mt-[50px]">
                            <button onClick={() => setToggleForm(false)} className="border-2 rounded-l-lg w-[100px] h-[50px]">Sign in</button>
                            <button onClick={() => setToggleForm(true)} className="bg-primary text-white rounded-r-lg w-[100px] h-[50px]">Sign up</button>
                        </div>
                        <div className="flex flex-col items-center h-[500px]">
                            <label className="mt-[50px] flex flex-col text-lg">
                                Username:
